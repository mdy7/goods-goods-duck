...
public class CommonJsonDeserializer {
	...
	static Map<String, Object> getStringObjectMap(String bootstrapServer, String apiKey, String apiSecret) {
		...
		props.put(org.springframework.kafka.support.serializer.JsonDeserializer.TYPE_MAPPINGS,
			"CountEventDto:spharos.nu.read.domain.goods.dto.event.CountEventDto," +
			"GoodsCreateEventDto:spharos.nu.read.domain.goods.dto.event.GoodsCreateEventDto," +
			"GoodsDeleteEventDto:spharos.nu.read.domain.goods.dto.event.GoodsDeleteEventDto," +
