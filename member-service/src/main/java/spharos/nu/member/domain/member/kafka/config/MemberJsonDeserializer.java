...
public class MemberJsonDeserializer {
	static Map<String, Object> getStringObjectMap(String bootstrapServer, String apiKey, String apiSecret) {
		...
		props.put(JsonDeserializer.TYPE_MAPPINGS, "JoinEventDto:spharos.nu.member.domain.member.dto.event.JoinEventDto,"
			+ "MemberScoreEventDto:spharos.nu.member.domain.member.dto.event.MemberScoreEventDto");
		...
		props.put(SaslConfigs.SASL_JAAS_CONFIG, String.format(
			"org.apache.kafka.common.security.plain.PlainLoginModule required username=\"%s\" password=\"%s\";", apiKey,
			apiSecret));
